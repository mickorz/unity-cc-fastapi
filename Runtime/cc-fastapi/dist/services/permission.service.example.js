 ...
 * 测试构建权限配置 - 纯粹模式
 */
export function testBuildPermissionConfigPure() {
    console.log('=== 测试纯粹模式 ===');
 ...
 * 测试构建权限配置 - 简单模式
 */
export function testBuildPermissionConfigSimple() {
    console.log('=== 测试简单模式 ===');
 ...
 * 测试构建权限配置 - 只读模式
 */
export function testBuildPermissionConfigReadonly() {
    console.log('=== 测试只读模式 ===');
 ...
 * 测试构建权限配置 - 可写工程模式
 */
export function testBuildPermissionConfigProjectwrite() {
 ...
 * 测试构建权限配置 - 外部目录
 */
export function testBuildPermissionConfigExternalDirs() {
    console.log('=== 测试外部目录 ===');
 ...
 * 测试构建权限参数
 */
export function testBuildPermissionArgs() {
 ...
 * 测试禁止幻觉提示词
 */
export function testApplyVisionRestriction() {
...
//# sourceMappingURL=permission.service.example.js.map