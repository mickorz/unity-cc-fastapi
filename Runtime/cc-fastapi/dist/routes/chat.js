 ...
 */
export async function handleStreamChat(request, reply) {
    // 从请求体获取参数
    ...
    const allowedmode = request.body.allowedmode?.trim();
 ...
 * @param reply - Fastify 响应对象
 */
export async function handleHealthCheck(_request, reply) {
    reply.send({
        status: 'ok',
